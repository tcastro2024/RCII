...
namespace Aula_3___Estruturas_de_controlo
{
    ...
    internal class Program
    {
        ...
        //    //2 - Leia n valores representativos do pH e mostre, para cada valor, que tipo de solução representa: ácida(pH < 7), neutra(pH = 7) ou alcalina(pH> 7) (for).

        //    //3 - Leia o número de golos marcados por uma equipa de futebol em um numero desconhecido de jogos  e no final mostre a média de golos por jogo(while).
